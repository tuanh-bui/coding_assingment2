...
public class DogApiBreedFetcher implements BreedFetcher {
    ...
    public List<String> getSubBreeds(String breed) throws BreedNotFoundException {
        String url = "http://dog.ceo/api/breed/" + breed.toLowerCase() + "/list";
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            if (!response.isSuccessful()) {
                throw new BreedNotFoundException("API call failed: " + response.code());
            }
            if (response.body() == null) {
                throw new BreedNotFoundException("Empty response body");
            }
            ...
            throw new BreedNotFoundException(" " + e);
        }
